	...
	<div class="container">
		<div class="row row1">
			<ul class="largenav pull-right">
				<li class="upper-links"><a class="links" href="Newsfeed">Home</a></li>
				<li class="upper-links"><a class="links"
					href="https://campusbox.org/">Link 2</a></li>
				<li class="upper-links"><a class="links"
		...
		<div class="row row2">
			<div class="col-sm-2">
				<h2 style="margin: 0px;">
					<span class="smallnav menu" onclick="openNav()">Samazon</span>
				</h2>
				<h1 style="margin: 0px;">
					<span class="largenav"><a href="Newsfeed" style="color:black;">Samazon</a></span>
				</h1>
			</div>
			...
			<div class="cart largenav col-sm-2">
				<a class="cart-button" onclick="location.href='MyCartServlet';">
					<svg
						class="cart-svg " width="12 " height="12 " viewBox="0 0 16 16 ">
                        <path 
